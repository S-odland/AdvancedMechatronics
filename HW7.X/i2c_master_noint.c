...
void i2c_write(int w_r_addr, int in_out, int contr_reg_addr){
    
    i2c_master_start();
    i2c_master_send(w_r_addr);
    i2c_master_send(contr_reg_addr);
    i2c_master_send(in_out);
    i2c_master_stop();
}
...
unsigned char i2c_read_multiple(unsigned char address_w, unsigned char address_r, unsigned char reg)
{
    i2c_master_start();
    i2c_master_send(address_w);
    i2c_master_send(reg);
    i2c_master_restart();
    i2c_master_send(address_r);
